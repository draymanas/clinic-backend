...
const servicesMetaMap = {
  ...
  'symptoms': {
    title: 'استشارات طبية مجانية | احكي أعراضك واعرف التخصص المناسب',
    desc: 'مش عارف تروح لأي دكتور؟ اكتب الأعراض التي تشعر بها وسيساعدك الفريق الطبي في تحديد التخصص المناسب وأفضل الأطباء المتاحين في محافظتك.',
    image: 'https://www.doctoreg.online/logo512.webp'
  },
  'consultations': {
    title: 'استشارات طبية مجانية | احكي أعراضك واعرف التخصص المناسب',
    desc: 'مش عارف تروح لأي دكتور؟ اكتب الأعراض التي تشعر بها وسيساعدك الفريق الطبي في تحديد التخصص المناسب وأفضل الأطباء المتاحين في محافظتك.',
...
app.post('/api/consultations', async (req, res) => {
    ...
    if (!question || !question.trim()) {
        return res.status(400).json({
            success: false,
            error: "من فضلك اكتب الأعراض أو الاستفسار أولاً."
        });
    }
